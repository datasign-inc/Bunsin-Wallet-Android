...
import jp.datasign.bunsin_wallet.createQueryParameterFromJson
import jp.datasign.bunsin_wallet.encodePublicKeyToJwks
...
class PresentationDefinitionTest {
    ...
    fun testDeserializeFromQueryParameter() {
        ...
        val queryParams = jp.datasign.bunsin_wallet.oid.decodeUriAsJson(uri)
