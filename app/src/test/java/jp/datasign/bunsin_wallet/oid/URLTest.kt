...
class URLTest {
    ...
    class Misc {
        ...
        fun testDecodeUriAsJsonWithVariousTypes() {
            ...
            val result = jp.datasign.bunsin_wallet.oid.decodeUriAsJson(uri)
        ...
        fun testDecodeUriAsJsonWithEmptyUri() {
            jp.datasign.bunsin_wallet.oid.decodeUriAsJson("")
        }

        @Test(expected = IllegalArgumentException::class)
        fun testDecodeUriAsJsonWithInvalidUri() {
            jp.datasign.bunsin_wallet.oid.decodeUriAsJson("http://example.com")
        }
        ...
        fun testParse() {
            ...
            val result = jp.datasign.bunsin_wallet.oid.parse(url)
...
//            JsonAutoDetect.Visibility.ANY))
    ...
    class ParseAndResolveSignedRequestTest : URLBaseTest() {
        ...
        fun testClientMetadata() = runBlocking {
            ...
            val result = jp.datasign.bunsin_wallet.oid.parseAndResolve(testUri)
