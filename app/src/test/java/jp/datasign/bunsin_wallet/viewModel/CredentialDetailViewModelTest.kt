...
import jp.datasign.bunsin_wallet.testData.TestDataUtil.sdJwtCredential
import jp.datasign.bunsin_wallet.testData.TestDataUtil.vcJwtCredential
import jp.datasign.bunsin_wallet.ui.credential_detail.CredentialDetailViewModel
...
class CredentialDetailViewModelTest {
    ...
    @Mock
    private lateinit var credentialDataObserver: Observer<jp.datasign.bunsin_wallet.datastore.CredentialData>

    @Mock
    private lateinit var matchedHistoriesObserver: Observer<List<jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory>>
    ...
    fun testFindHistoriesByCredentialId() = runTest {
        ...
        val mockHistories = listOf(
            mock(jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory::class.java),
            mock(jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory::class.java)
        )
