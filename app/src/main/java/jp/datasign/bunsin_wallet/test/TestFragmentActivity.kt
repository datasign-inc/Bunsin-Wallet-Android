package jp.datasign.bunsin_wallet.test
...
import jp.datasign.bunsin_wallet.databinding.TestFragmentActivityBinding
import jp.datasign.bunsin_wallet.datastore.CredentialData
import jp.datasign.bunsin_wallet.datastore.CredentialDataStore
import jp.datasign.bunsin_wallet.test.DummyData.generateSdJwt
import jp.datasign.bunsin_wallet.ui.credential_detail.CredentialDetailFragment
import jp.datasign.bunsin_wallet.ui.siop_vp.request_content.RequestContentFragment
import jp.datasign.bunsin_wallet.utils.KeyPairUtil
import jp.datasign.bunsin_wallet.utils.ZipUtil
...
class TestFragmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isKeyPairExist = KeyPairUtil.isKeyPairExist(Constants.Cryptography.KEY_BINDING)
        if (!isKeyPairExist) {
...
//        navController.navigate(R.id.id_token_sharring, args)
        ...
        val fragment = RequestContentFragment().apply {
            arguments = args
        }
...
//            .commit();
    ...
    suspend fun createTestData() {
        ...
        val vcData1 = jp.datasign.bunsin_wallet.datastore.CredentialData.newBuilder()
        ...
        val vcData2 = jp.datasign.bunsin_wallet.datastore.CredentialData.newBuilder()
            .setId(UUID.randomUUID().toString())
            .setFormat("vc+sd-jwt")
            .setCredential(sdJwt)
            .setCNonce("test_CNonce")
