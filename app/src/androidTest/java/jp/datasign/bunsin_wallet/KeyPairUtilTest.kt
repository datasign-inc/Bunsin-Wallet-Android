...
import jp.datasign.bunsin_wallet.utils.KeyPairUtil.verifyJwt
import jp.datasign.bunsin_wallet.utils.KeyStoreHelper
import jp.datasign.bunsin_wallet.utils.KeyStoreHelper.generateSecretKey
...
class KeyStoreHelperTest {
    ...
    @Before
    fun cleanup() {
        val keyStore = KeyStore.getInstance(Constants.Cryptography.KEYSTORE_TYPE).apply {
            load(null)
        }
