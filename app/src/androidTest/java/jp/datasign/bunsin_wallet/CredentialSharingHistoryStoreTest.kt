...
class CredentialSharingHistoryStoreTest {
    ...
    fun testSaveAndGetAllHistories1History() = runBlocking {
        ...
        val history = jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory.newBuilder()
            .setRp("someRp")
            .setAccountIndex(1)
            .setCreatedAt(
    ...
    fun testSaveAndGetAllHistories2History() = runBlocking {
        ...
        val history1 = jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory.newBuilder()
            .setRp("someRp1")
            .setAccountIndex(1)
            .setCreatedAt(
                Timestamp.newBuilder()
        ...
        val history2 = jp.datasign.bunsin_wallet.datastore.CredentialSharingHistory.newBuilder()
            .setRp("someRp2")
            .setAccountIndex(2)
            .setCreatedAt(
                Timestamp.newBuilder()
