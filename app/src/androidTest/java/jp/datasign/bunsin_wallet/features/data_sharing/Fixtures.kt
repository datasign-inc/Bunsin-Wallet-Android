package jp.datasign.bunsin_wallet.features.data_sharing
...
import jp.datasign.bunsin_wallet.oid.Field
import jp.datasign.bunsin_wallet.oid.InputDescriptor
import jp.datasign.bunsin_wallet.oid.InputDescriptorConstraints
  ...
  "display": [
    {
      ...
      "locale": "en-US",
      "logo": {
        "uri": "https://datasign.jp/public/logo.png",
