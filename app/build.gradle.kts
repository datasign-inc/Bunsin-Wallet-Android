...
android {
    namespace = "jp.datasign.bunsin_wallet"
    compileSdk = 34

    defaultConfig {
        applicationId = "jp.datasign.bunsin_wallet"
        minSdk = 33
        targetSdk = 34
        versionCode = 2
        versionName = "0.0.1"
    ...
    buildTypes {
        release {
            ...
            resValue(
                "string",
                "TERM_OF_USE_URL",
                "https://bunsin.io/wallet/tos/index.html"
            )
            resValue(
                "string",
                "PRIVACY_POLICY_URL",
                "https://bunsin.io/wallet/privacy/index.html"
            )
            resValue("string", "SUPPORT_URL", "")
            resValue(
                "string",
                "LICENCE_URL",
...
dependencies {
    ...
    implementation("androidx.core:core-ktx:1.9.25")
